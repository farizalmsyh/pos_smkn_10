                ...
                <div class="card-title">
                    <div class="btn-group dropleft float-right">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="{{route('produk-in-print-all')}}">Semua Data</a>
                            <button class="dropdown-item" data-toggle="modal" data-target="#modalRangeDate">Date Range</button>
                        </div>
                    </div>
                    <h5 class="pt-2"><i class="fas fa-file-import"></i>&nbsp;Laporan Barang Masuk</h5>
                </div>
            </div>
            <div class="card-body">
    ...
    <div class="modal-content">
      <div class="modal-header bg-primary">
		...
		<div class="modal-body">
			<div class="row justify-content-center">
				<div class="col-md-10">
					<form class="row" id="delete-account-form" action="{{ route('produk-in-print-date') }}" method="POST">
					{{ csrf_field() }}
