...
<!-- Content Row -->
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
            <div class="col mr-2">
                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Toko</div>
    ...
    <div class=" col-md-12 mb-2 px-0">
        <div class="card border-left-warning shadow py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Selamat Datang !!</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">Selamat datang di Dashboard POS SMK Negeri 10 Jakarta</div>
                    </div>
                </div>
            </div>
        </div>
